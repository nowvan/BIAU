...
// sort, it's stable.
  ...
  function insertTag(node, parts) {
    ...
    if (parts.length === 1) {
      ...
      // this tag.
      let child = node.properties && node.properties.find(property => parts[0] === _.last(property.name.split(PATH_SPLIT)));
 ...
 */
var nest = comment => Object.assign(comment, {
